...
exports.CHECK_NP = "SELECT * FROM `astrologer` WHERE email = ?";
exports.CHECK_AL = "SELECT * FROM `paediatrician` WHERE email = ?";
exports.CHECK_PT = "SELECT * FROM `baby_name_provider` WHERE email = ?";
