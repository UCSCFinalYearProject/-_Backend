...
exports.selected_pediatricianList = " SELECT * FROM `paediatrician` WHERE `user_id`=?; " ;
exports.selected_astroList = " SELECT * FROM `astrologer` WHERE `user_id`=?; " ;
exports.selected_NPList = " SELECT * FROM `baby_name_provider` WHERE `user_id`=?; " ;
