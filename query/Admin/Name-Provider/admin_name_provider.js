...
exports.Baby_Name_Provider_Requests = " SELECT * FROM `baby_name_provider` where STATUS=2" ;
...
exports.accept_np = " UPDATE `baby_name_provider` SET `STATUS` = '0' WHERE `baby_name_provider`.`user_id` = ?" ;
exports.reject_np = " DELETE FROM baby_name_provider WHERE `baby_name_provider`.`user_id` = ?" ;
