...
exports.REGISTER_User_al = "INSERT INTO `astrologer`(name, password, email, service_charge, registered_at) VALUES ( ?, 2000, CURRENT_DATE())" ;

exports.REGISTER_User_np = "INSERT INTO `baby_name_provider`(name, password, email, service_charge, registered_at) VALUES ( ?, 2000, CURRENT_DATE())" ;
